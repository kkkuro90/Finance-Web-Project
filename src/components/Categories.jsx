  ...
  const saveEdit = async () => {
    ...
    try {
      ...
      if (editingCategory.type === 'income') {
        setIncomeCategories(incomeCategories.map(cat => cat.id === editingCategory.id ? res.data : cat));
      } else {
        setExpenseCategories(expenseCategories.map(cat => cat.id === editingCategory.id ? res.data : cat));
        if (selectedCategory === editingCategory.name) setSelectedCategory(res.data.name);
      }
